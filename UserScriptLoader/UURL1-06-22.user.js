...
var _Q=function(d) {return document.querySelector(d)};
    ...
    function Yx(e){var YD=_Q('#YDn');var YY=111;if (!window.chrome)YY=161;YD.style.top=e.screenY-YY+"px";YD.style.left=e.screenX-20+"px";YD.style.display='';}
...
setTimeout(function(){  GM_xmlhttpRequest({
  ...
  l[i].href=y.finalUrl;
    ...
    if(location.hostname.indexOf('google')>0){t.removeAttribute('onmousedown');t.title="已去除GG襁褓！防挂\n By Yulei";return};//针对GG的劫持
  ...
  method: Yod,
  onload: function(y) {
      if (!y.status){t.title="此网站挂了！";t.style.textDecoration="line-through"}
      if (y.status == '404' || y.status == '403'){t.title="40X啦，找不到你的！";t.style.borderBottom="3px double red"} 
...
document.body.appendChild(aa);
    aa.innerHTML='<i>你打开后的地址(源地址)为：</i><span title="复制地址（成功不提示，否则反之）" style="color:#19AAD5;cursor:pointer;" id="Ycp">[复制]</span><br><div style="overflow:hidden;width:98%"><a id="YNd" target="_blank" style="white-space:nowrap;color:#1F76B0" title="By Yulei"></a></div><b style="font-family:Tahoma,Verdana,Arial;transform: rotate(-90deg);-webkit-transform: rotate(-90deg);position:absolute;left:10px;bottom:-21px;color:#D2DF1D;width:20px;height:35px">∠</b>';
