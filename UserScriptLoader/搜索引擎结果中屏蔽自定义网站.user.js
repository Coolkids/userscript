// ==UserScript==
// @name AC-从Google Baidu Bing等搜索引擎结果中屏蔽自定义网站 - mod
...
var dir_fatherName = new Array("f13", "b_attribution", "f kv _SWb", "res-linkinfo", "result-footer", "fb"); 
//网址节点的最终父节点-一一对应
var end_fatherName = new Array("result c-container ", "b_algo", "g", "res-list", "rnw default", "rb"); 
var map={};
initMap();
