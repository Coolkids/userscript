...
var gSimpleSessionManager = {
	...
	insertafter: 'addon-bar',  ////urlbar-icons  status-bar addon-bar searchbar TabsToolbar alltabs-button go-button
	...
	loadMenu : function () {
		if (1 === this._displayType) {
			...
			menu.setAttribute("id", "ssmm_toolbarbutton");
