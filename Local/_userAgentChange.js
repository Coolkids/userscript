...
SITE_LIST = [
		//直接可以看kankan视频，无需高清组件
		{
			...
			url: /^http:\/\/v\.huya\.com\/play\//,
			Name: "iPad2"
		}, {
			url: /^http:\/\/www\.meipai\.com\/media\/\d+/,
			Name: "iPad2"
		}, {
			url: /^http:\/\/wap\./,
			Name: "UCBrowser"
	...
	UA_LIST = [{
		...
		{
			name: "Chrome22.0.1219.0 - Windows7",
